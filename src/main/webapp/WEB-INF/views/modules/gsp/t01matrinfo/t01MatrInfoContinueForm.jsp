<%@ page contentType="text/html;charset=UTF-8" %>
	...
	function queryThisForm(){
		$.ajax({
			url:"${ctx}/gsp/t01matrinfo/t01MatrInfo/getRecord",
			type:"get",
...
<body>
	...
	<ul class="breadcrumb">
	  ...
	  <li class="active">物料信息变更</li>
	</ul>
	<!-- 每页的title（文字换为变量） -->
	<div id="topTitle">物料信息变更</div>

	<form:form id="inputForm" modelAttribute="t01MatrInfo" action="${ctx}/gsp/t01matrinfo/t01MatrInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
							<form:input path="matrNbr" htmlEscape="false" maxlength="128" class="input-xlarge required"/>
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
					...
					<form:input path="matrNbr" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
							<form:input path="matrNmCn" htmlEscape="false" maxlength="128" class="input-xlarge required"/>
                                <span class="help-inline"><font color="red">*</font> </span>
					</div>
				</div>
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="matrNmCn" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
							<form:input path="matrNmEn" htmlEscape="false" maxlength="128" class="input-xlarge required"/>
                                <span class="help-inline"><font color="red">*</font> </span>
					</div>
				</div>
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="matrNmEn" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
							<form:input path="matrDesc" htmlEscape="false" maxlength="500" class="input-xlarge required"/>
                                <span class="help-inline"><font color="red">*</font> </span>
					</div>
				</div>
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="matrDesc" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
							<form:select path="matrType" class="input-xlarge ">
		<form:option value="" label=""/>
								<form:options items="${fns:getDictList('matrType')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
	</form:select>
					</div>
				</div>
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="matrType" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
			</div>
				<div role="tabpanel"  class=
		...
		<div class="control-group">
			...
			<div class="controls">
							<form:input path="priceUnit" htmlEscape="false" maxlength="64" class="input-xlarge required"/>
                                <span class="help-inline"><font color="red">*</font> </span>
					</div>
				</div>
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="priceUnit" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls">
							<form:input path="matrPrice" htmlEscape="false" class="input-xlarge required"/>
                                <span class="help-inline"><font color="red">*</font> </span>
					</div>
				</div>
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="matrPrice" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
			</div>
		...
		<div id="footBtnDiv" class="form-actions">
			...
			<shiro:hasPermission name="gsp:t01matrinfo:t01MatrInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="button" onclick="saveTest()" value="保 存"/>&nbsp;</shiro:hasPermission>
		</div>
	</form:form>
    <script>
