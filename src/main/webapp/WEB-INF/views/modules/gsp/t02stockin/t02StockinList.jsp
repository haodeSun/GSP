...
<body>
	...
	<!-- 每页的title（文字换为变量） -->
	<div id="topTitle">入库信息删除</div>
	<!--20161113-->
	
	<form:form id="searchForm" modelAttribute="t02Stockin" action="${ctx}/gsp/t02stockin/t02Stockin/" method="post" class="breadcrumb form-search">
	...
	<shiro:hasPermission name="gsp:t02stockin:t02Stockin:edit">
		<a href="${ctx}/gsp/t02stockin/t02Stockin/delete?id=${t02Stockin.id}" onclick="return confirmx('确认要删除该入库信息吗？', this.href)"><span class="newBtn btn btn-primary">删除</span></a>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>入库时间</th>
				<th>审核人</th>
				<shiro:hasPermission name="gsp:t02stockin:t02Stockin:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="t02Stockin">
			<tr>
				<td><input type="checkbox" onchange="checkAll()"/></td>
				<td><a href="${ctx}/gsp/t02stockin/t02Stockin/form?id=${t02Stockin.id}">
					<fmt:formatDate value="${t02Stockin.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</a></td>
				<td>
					${t02Stockin.remarks}
				</td>
				...
				<td>
					<fmt:formatDate value="${t02Stockin.stocDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					${t02Stockin.auditPers}
				</td>
			</tr>
		</c:forEach>
		</tbody>
