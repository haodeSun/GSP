...
<body>
	...
	<!-- 每页的title（文字换为变量） -->
	<div id="topTitle">出库信息删除</div>
	<!--20161113-->
	<form:form id="searchForm" modelAttribute="t02Stockout" action="${ctx}/gsp/t02stockout/t02Stockout/" method="post" class="breadcrumb form-search">
	...
	<shiro:hasPermission name="gsp:t02stockout:t02Stockout:edit">
		<a href="${ctx}/gsp/t02stockout/t02Stockout/delete?id=${t02Stockout.id}" onclick="return confirmx('确认要删除该出库信息吗？', this.href)"><span class="newBtn btn btn-primary">删除</span></a>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>库房管理员签字</th>
				<th>审核人</th>
				<shiro:hasPermission name="gsp:t02stockout:t02Stockout:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="t02Stockout">
			<tr>
				<td><input type="checkbox" onchange="checkAll()"/></td>
				<td><a href="${ctx}/gsp/t02stockout/t02Stockout/form?id=${t02Stockout.id}">
					${t02Stockout.stocNumb}
				</a></td>
				<td>
					${t02Stockout.checkNo}
				</td>
				<td>
					<fmt:formatDate value="${t02Stockout.stocDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					${t02Stockout.wareName}
				</td>
				<td>
					${t02Stockout.wareSign}
				</td>
				<td>
					${t02Stockout.auditPers}
				</td>
			</tr>
		</c:forEach>
		</tbody>
