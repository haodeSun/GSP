<%@ page contentType="text/html;charset=UTF-8" %>
	...
	function queryThisForm(){
		$.ajax({
			url:"${ctx}/gsp/t02reviewhistory/t02ReviewHistory/getRecord",
			type:"get",
...
<body>
	...
	<ul class="breadcrumb">
	  ...
	  <li class="active">审核记录变更</li>
	</ul>
	<!-- 每页的title（文字换为变量） -->
	<div id="topTitle">审核记录变更</div>
	...
	<form:form id="inputForm" modelAttribute="t02ReviewHistory" action="${ctx}/gsp/t02reviewhistory/t02ReviewHistory/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="reivewType" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
		...
		<form:option value="" label=""/>
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="reviewResult" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
		...
		<div class="control-group">
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="reviewInst" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
			</div>
		...
		<div id="footBtnDiv" class="form-actions">
			...
			<shiro:hasPermission name="gsp:t02reviewhistory:t02ReviewHistory:edit"><input id="btnSubmit" class="btn btn-primary" type="button" onclick="saveTest()" value="保 存"/>&nbsp;</shiro:hasPermission>
		</div>
	</form:form>
    <script>
