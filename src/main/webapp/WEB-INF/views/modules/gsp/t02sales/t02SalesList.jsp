...
<body>
	...
	<!-- 每页的title（文字换为变量） -->
	<div id="topTitle">售出信息删除</div>
	<!--20161113-->
	
	<form:form id="searchForm" modelAttribute="t02Sales" action="${ctx}/gsp/t02sales/t02Sales/" method="post" class="breadcrumb form-search">
	...
	<shiro:hasPermission name="gsp:t02sales:t02Sales:edit">
		<a href="${ctx}/gsp/t02sales/t02Sales/delete?id=${t02Sales.id}" onclick="return confirmx('确认要删除该售出信息吗？', this.href)"><span class="newBtn btn btn-primary">删除</span></a>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>购货者id</th>
				<th>订单总价</th>
				<shiro:hasPermission name="gsp:t02sales:t02Sales:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="t02Sales">
			<tr>
				<td><input type="checkbox" onchange="checkAll()"/></td>
				<td><a href="${ctx}/gsp/t02sales/t02Sales/form?id=${t02Sales.id}">
					${t02Sales.salesNumb}
				</a></td>
				<td>
					<fmt:formatDate value="${t02Sales.salesDate}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
				<td>
					${t02Sales.custCompanyId}
				</td>
				<td>
					${t02Sales.totalOrderPrice}
				</td>
			</tr>
		</c:forEach>
		</tbody>
