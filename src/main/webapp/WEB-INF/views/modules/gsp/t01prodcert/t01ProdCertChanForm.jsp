...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            for (var j = 0, inputLen = $("#inputForm").find(".controls").length; j < inputLen; j++) {
                ...
                if ($.inArray(inputId, testArray) == -1) {
                    ...
                    $("input[name='regiCertNbr']").css('width','30.6%');
                }
                else {
                    //只有当符合这两个字段的时候添加必填符号
        ...
        function queryThisForm() {
            ...
            var recordUrl = "${ctx}/gsp/t01prodcert/t01ProdCert/getRecord";
            $.ajax({
                url: recordUrl,
                type: "get",
...
<ul class="breadcrumb">
    ...
    <li class="active">产品资质变更</li>
</ul>
<!-- 每页的title（文字换为变量） -->
<div id="topTitle">产品资质变更</div>

<form:form id="inputForm" modelAttribute="t01ProdCert" action="${ctx}/gsp/t01prodcert/t01ProdCert/chanSave" method="post"
    ...
    <div class="tab-content">
        <div role="tabpanel" class=
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input  path="regiCertNbr" htmlEscape="false" maxlength="250" class="input-xlarge required"/>
                    <span/>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:select  path="riskClass"  disabled="true" class="input-xlarge ">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:select path="techCateCd" disabled="true" class="input-xlarge required">
                        <form:option value="" label=""/>
        ...
        <div role="tabpanel" class=
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input  path="prodNameCn"  disabled="true" htmlEscape="false" maxlength="250" class="input-xlarge "/>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input  path="prodNameEn"  disabled="true" htmlEscape="false" maxlength="250" class="input-xlarge "/>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input  path="modelSpec"  disabled="true" htmlEscape="false" maxlength="250" class="input-xlarge "/>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input  path="struComp"  disabled="true" htmlEscape="false" maxlength="1000" class="input-xlarge "/>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input  path="mainMnt"  disabled="true" htmlEscape="false" maxlength="1000" class="input-xlarge "/>
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input  path="expeUsage"  disabled="true" htmlEscape="false" maxlength="1000" class="input-xlarge "/>
                </div>
            </div>
        ...
        <div role="tabpanel" class=
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <form:input path="saledServOrg" disabled="true" htmlEscape="false" maxlength="250" class="input-xlarge "/>                </div>
            </div>
