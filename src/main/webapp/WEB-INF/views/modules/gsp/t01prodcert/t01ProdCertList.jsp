...
<head>
	...
	<script>
        $(document).ready(function(){
            setTableDefault("t01ProdCert","${ctx}/sys/user/getSysUserConfig");
            holdTable("holdTable","t01ProdCert","${ctx}/sys/user/setSysUserConfig");
        })
	</script>
</head>
<body>
...
<ul class="breadcrumb">
	...
	<li class="active">产品资质查询</li>
</ul>
<!-- 每页的title（文字换为变量） -->
<div id="topTitle">产品资质查询</div>
<!--20161113-->

<form:form id="searchForm" modelAttribute="t01ProdCert" action="${ctx}/gsp/t01prodcert/t01ProdCert/" method="post" class="breadcrumb form-search">
...
<shiro:hasPermission name="gsp:t01prodcert:t01ProdCert:edit">
	<a href="javascript:void(0);" onclick="update();"><span class="modifySpan newBtn btn btn-primary">修改</span></a>
</shiro:hasPermission>
