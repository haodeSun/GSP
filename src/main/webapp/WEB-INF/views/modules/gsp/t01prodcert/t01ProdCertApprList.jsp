...
<head>
	...
	<script type="text/javascript">
        function appr(){
            ...
            window.location.href = "${ctx}/gsp/t01prodcert/t01ProdCert/toDoTask?prodCertId="+dataId;
		}
	</script>
</head>
<body>
...
<form:form id="searchForm" modelAttribute="t01ProdCert" action="${ctx}/gsp/t01prodcert/t01ProdCert/toAppr" method="post" class="breadcrumb form-search">
...
<shiro:hasPermission name="gsp:t01prodcert:t01ProdCert:edit">
	<a href="javascript:void(0);" onclick="appr()"><span class="modifySpan newBtn btn btn-primary">审批</span></a>
</shiro:hasPermission>
