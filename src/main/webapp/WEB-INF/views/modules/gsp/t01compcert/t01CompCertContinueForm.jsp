<%@ page contentType="text/html;charset=UTF-8" %>
	...
	function queryThisForm(){
		$.ajax({
			url:"${ctx}/gsp/t01compcert/t01CompCert/getRecord",
			type:"get",
...
<body>
	...
	<ul class="breadcrumb">
	  ...
	  <li class="active">企业资质变更</li>
	</ul>
	<!-- 每页的title（文字换为变量） -->
	<div id="topTitle">企业资质变更</div>
	...
	<form:form id="inputForm" modelAttribute="t01CompCert" action="${ctx}/gsp/t01compcert/t01CompCert/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="certNbr" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
		...
		<div class="control-group">
									<label class="control-label">机构名称/销售人员姓名：</label>
			<div class="controls">
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="certName" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>

		<div class="control-group">
									<label class="control-label">生产/经营/销售范围/诊疗科目：</label>
			<div class="controls">
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="certScop" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>

		<div class="control-group">
									<label class="control-label">生效日期/发证日期：</label>
			<div class="controls">
		...
		<div class="control-group">
			...
			<div class="controls" style="display:inline-block; float:left; margin-left:20px;">
				...
				<div class="remarkDiv controls" style="display:inline-block; float:left; margin-left:24px;">
				    <label class="control-label">备注：</label>
					<form:input path="certStat" htmlEscape="false" maxlength="100" class="input-xlarge "/>
				</div>
			</div>
		...
		<div id="footBtnDiv" class="form-actions">
			...
			<shiro:hasPermission name="gsp:t01compcert:t01CompCert:edit"><input id="btnSubmit" class="btn btn-primary" type="button" onclick="saveTest()" value="保 存"/>&nbsp;</shiro:hasPermission>
		</div>
	</form:form>
    <script>
