    ...
    <div id="collapseOne" class="accordion-body collapse in">
        <div class="accordion-inner">
            ...
            <ul id="conditionOrderUl" class="ul-form">
                ...
                <li style="display:none;"><label>供货者状态：</label>
                    <form:select path="suplStat" class="input-medium">
                ...
                <li style="display:none;"><label>生产资质状态：</label>
                    <form:select path="t01CompCert2.certStat" class="input-medium">
                        <form:option value="" label="请选择"/>
                        <form:options items="${fns:getDictList('t01_certStat')}" itemLabel="label" itemValue="value"
                                      htmlEscape="false"/>
                    </form:select>
                ...
                <li style="display:none;"><label>备注：</label>
                    <form:input path="t01CompInfo.remarks" htmlEscape="false"
                                maxlength="250" class="input-medium"/>
                    <span class="btn btn-primary" onclick="deleteSelf(this)">一</span>
                </li>
                ...
                <li style="display:none;"><label>编号：</label>
                    <form:input path="t01CompCert2.certNbr" htmlEscape="false"
                                maxlength="250" class="input-medium"/>
                    <span class="btn btn-primary" onclick="deleteSelf(this)">一</span>
                </li>
                <li style="display:none;"><label>企业名称：</label>
                    <form:input path="t01CompCert2.certName" htmlEscape="false"
                                maxlength="250" class="input-medium"/>
                    <span class="btn btn-primary" onclick="deleteSelf(this)">一</span>
                </li>
                <%--<li style="display:none;"><label>生产范围：</label>--%>
                    <%--<form:input path="t01CompCert2.certScop" htmlEscape="false"--%>
                                <%--maxlength="250" class="input-medium"/>--%>
                    <%--<span class="btn btn-primary" onclick="deleteSelf(this)">一</span>--%>
                <%--</li>--%>
                <li style="display:none;"><label>生产资质发证日期：</label>
                    <input name="t01CompCert2.effecDateBg" type="text" readonly="readonly"class="input-medium datepicker"/>
                    <span class="btn btn-primary" onclick="deleteSelf(this)">一</span>
                </li>
                <li style="display:none;"><label>生产资质有效期至：</label>
                    <input name="t01CompCert2.validDateEd" type="text" readonly="readonly"class="input-medium datepicker"/>
                    <span class="btn btn-primary" onclick="deleteSelf(this)">一</span>
                </li>
                <li style="display:none;"><label>生产能力评价：</label>
                    <form:input path="t01CompInfo.prodAbliEval" htmlEscape="false"
                                maxlength="250" class="input-medium"/>
                    <span class="btn btn-primary" onclick="deleteSelf(this)">一</span>
                </li>
                <li style="display:none;"><label>质量管理评价：</label>
                    <form:input path="t01CompInfo.qualMgrEval" htmlEscape="false"
                                maxlength="250" class="input-medium"/>
                    <span class="btn btn-primary" onclick="deleteSelf(this)">一</span>
                </li>
                <li style="display:none;"><label>仓储能力评价：</label>
                    <form:input path="t01CompInfo.storAbliEval" htmlEscape="false"
                                maxlength="250" class="input-medium"/>
                    <span class="btn btn-primary" onclick="deleteSelf(this)">一</span>
                </li>
                <li style="display:none;"><label>交付能力评价：</label>
                    <form:input path="t01CompInfo.deliAbliEval" htmlEscape="false"
                                maxlength="250" class="input-medium"/>
                    <span class="btn btn-primary" onclick="deleteSelf(this)">一</span>
                </li>
                <li style="display:none;"><label>售后服务能力评价：</label>
                    <form:input path="t01CompInfo.afteSaleAbliEval" htmlEscape="false"
                                maxlength="250" class="input-medium"/>
                    <span class="btn btn-primary" onclick="deleteSelf(this)">一</span>
                </li>
            </ul>
