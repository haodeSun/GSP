...
<body>
	<ul class="breadcrumb">
		...
		<li>通知通告<span class="divider">></span></li>
		<li class="active">通告管理</li>
	</ul>
	<!-- 每页的title（文字换为变量） -->
	<div id="topTitle">通知添加</div>
	...
	<form:form id="inputForm" modelAttribute="oaNotify" action="${ctx}/oa/oaNotify/save" method="post" class="form-horizontal">
		...
		<c:if test="${oaNotify.status eq '1'}">
			...
			<div class="control-group">
				<div class="controls">
					<a href="${ctx}/sys/sysAlarm/reject?id=${oaNotify.remarks}" ><span class="newBtn btn btn-primary">取消预警</span></a>
				</div>
			</div>
			<div class="control-group">
				<label class="control-label">接受人：</label>
