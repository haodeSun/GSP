...
public class FreeMarkers {
	...
	public static String renderString(String fileName, String templateString, Map<String, ?> model) {
		try {
			StringWriter result = new StringWriter();
			Template t = new Template(fileName, new StringReader(templateString), new Configuration());
