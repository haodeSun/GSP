...
public class Page<T> {
	...
	private static final int defaultPageSize = Integer.valueOf(Global.getConfig("page.pageSize"));
	
	private int pageNo = 1; // 当前页码
	private int pageSize = defaultPageSize; // 页面大小，设置为“-1”表示不进行分页（分页无效）
...
//	}
	...
	public void setCount(long count) {
		...
		// 设置总条数之后，重新计算分页参数，否则会造成，显示数据和页号不符这种情况
		initialize();
	}
