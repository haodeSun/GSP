...
//		System.out.println("dataScopeFilter: " + sqlString.toString());
	 ...
	 * @return 表名
	 */
	public static String getTableFromModule(String module) {
		String table;
		switch (module) {
			case "t01MatrInfo":
				table = "t01_matr_info";
	 ...
	 * @return 模块名称
	 */
	public static String getModuleFromTable(String table) {
		String module;
		switch (table) {
			case "t01_matr_info":
				module = "t01MatrInfo";
				break;
			case "t01_compl_buyer":
				module = "t01ComplBuyer";
				break;
			case "t01_comp_aggr":
				module = "t01CompAggr";
				break;
	 ...
	 * @param table 表名
	 * @param id        id
	 * @DataNotExistException 抛出异常
	 */
	protected void checkDataExistById(String table, String id) throws DataNotExistException {
		if (commonDao.checkDataExistById(table, id) == 0) {
			throw new DataNotExistException("该数据不存在，请刷新后再试", "");
		}
	}
	 ...
	 * @return 状态
	 */
	protected String checkCertStat(Date beginDate, Date endDate) {
	...
	/**
	 * 插入操作历史
	 * @param module 模块名称  t01MatrInfo/t01ComplBuyer
	 * @param dataId 数据id
	 * @param operateType 0 解冻 1冻结 2提交审批 3审批通过 4审批不通过
	 */
	protected void insertOperateHist(String module,String dataId,String operateType){
		T01OperateHist t01OperateHist = new T01OperateHist();
		t01OperateHist.setModule(module);
		t01OperateHist.setDataId(dataId);
		t01OperateHist.setOperateType(operateType);
