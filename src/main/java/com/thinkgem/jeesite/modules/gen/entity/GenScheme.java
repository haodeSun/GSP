...
import com.thinkgem.jeesite.modules.gen.web.Group;
...
public class GenScheme extends DataEntity<GenScheme> {
	...
	private List<Group> columnGroupList;
	public GenScheme() {
		super();
	}
	...
	public List<Group> getColumnGroupList() {
		return columnGroupList;
	}

	public void setColumnGroupList(List<Group> columnGroupList) {
