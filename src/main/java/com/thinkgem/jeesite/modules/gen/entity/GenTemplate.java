...
public class GenTemplate extends DataEntity<GenTemplate> {
	...
	private List<GenOverrideConfig.ActionConf> actions = new ArrayList<>();
	...
	public void setActions(List<GenOverrideConfig.ActionConf> actions) {
		this.actions = actions;
	}

	public List<GenOverrideConfig.ActionConf> getActions() {
		return actions;
	}
}
