...
//					List<HistoricIdentityLink> il = historyService.getHistoricIdentityLinksForProcessInstance(procInsId);
	...
	public String startProcess(String procDefKey, String businessTable, String businessId, String title, Map<String, Object> vars) {
		...
		act.setStatus(ApprStatus.NOAPPR.toString());
		actDao.updateStatusByBusinessId(act);

		ProcessInstance procIns = startProcess(procDefKey, businessTable, businessId, vars);
	...
	/**
	 * 针对非审核流程，没有businessTable和businessId
	 * @param procDefKey
	 * @param businessTable
	 * @param businessId
	 * @param vars
	 * @return
	 */
	public ProcessInstance startProcess(String procDefKey,String businessTable,String businessId,Map<String, Object> vars){
		String businessKey = "";
		if (businessTable != null && businessId != null) {
			businessKey = businessTable+":"+businessId;
		}
...
//		return ProcessDiagramGenerator.generateDiagram(bpmnModel, "png", activeActivityIds);
	...
	public List<Map<String, Object>> traceProcess(String processInstanceId) throws Exception {
		...
		List<Map<String, Object>> activityInfo = new ArrayList<>();
		for (ActivityImpl activity : activitiList) {
			...
			activityInfo.add(activityImageInfo);
		}
