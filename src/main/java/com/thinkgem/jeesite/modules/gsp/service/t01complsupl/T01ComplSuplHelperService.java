...
public class T01ComplSuplHelperService extends BaseService {


    private final static String TABLE = "t01_compl_supl";
     ...
     */
    public void checkStatusBeforeHandle(String handle, T01ComplSupl entity) throws BeforeHandleStatusErrorException, DataNotExistException {
    ...
    private void checkOnlyByComp(T01ComplSupl entity) throws BeforeHandleStatusErrorException {
        if (t01ComplSuplDao.checkOnlyByComp(entity) > 0) {
            throw new BeforeHandleStatusErrorException("该企业已添加供货者，无法再次添加", "");
        }
    }

    private void checkStatusBeforeSave(T01ComplSupl entity) throws BeforeHandleStatusErrorException {
        if (StringUtils.isBlank(entity.getT01CompInfo().getId())) {
            throw new BeforeHandleStatusErrorException("添加供货者必须绑定企业信息", "");
        }
        checkOnlyByComp(entity);
    }


    private void checkStatusBeforeEdit(T01ComplSupl entity) throws BeforeHandleStatusErrorException {

        entity = t01ComplSuplDao.get(entity.getId());
    ...
    private void checkStatusBeforeDelete(T01ComplSupl entity) throws BeforeHandleStatusErrorException {
        if (ApprStatus.PASS.toString().equals(entity.getApprStat())) {
    ...
    private void checkStatusBeforeChange(T01ComplSupl entity) throws BeforeHandleStatusErrorException, DataNotExistException {
    ...
    private void checkStatusBeforeAppr(T01ComplSupl entity) throws BeforeHandleStatusErrorException {
        entity = t01ComplSuplDao.get(entity.getId());
