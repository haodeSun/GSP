 ...
 * @version 2016-12-15
 */
public class SysChangeInfoForT01ComplSupl extends DataEntity<SysChangeInfoForT01ComplSupl> {
  ...
  private T01ComplSupl chanId; // 变更表_记录id 父类
  private String chanType; // 变更类型
  private String orgiValue; // 原值
  private String chanValue; // 变更值
  private String chanReason; // 变更原因

  public SysChangeInfoForT01ComplSupl() {
    super();
  }

  public SysChangeInfoForT01ComplSupl(String id) {
    super(id);
  }

  public SysChangeInfoForT01ComplSupl(T01ComplSupl chanId) {
    this.chanId = chanId;
  }
  ...
  public T01ComplSupl getChanId() {
    return chanId;
  }

  public void setChanId(T01ComplSupl chanId) {
    this.chanId = chanId;
  }
